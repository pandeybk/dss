			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="isDeductible" title="${message(code: 'category.isDeductible.label', default: 'Is Deductible')}" />
				...
				<g:each in="${categoryInstanceList}" status="i" var="categoryInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:formatBoolean boolean="${categoryInstance.isDeductible}" /></td>
